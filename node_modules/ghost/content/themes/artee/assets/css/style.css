...
.artee-site-head .artee-blog-title .artee-header:after,
.artee-index-content .artee-mobile-sort:after,
.artee-index-content .artee-index-sort:after {
  content: " ";
  display: table; }

.cf:after, .artee-site-head .artee-blog-title:after, .artee-site-head .artee-blog-description:after, .artee-site-head .artee-blog-title .artee-header:after, .artee-index-content .artee-mobile-sort:after, .artee-index-content .artee-index-sort:after {
  clear: both; }
...
.artee-site-head {
  ...
  .artee-site-head .artee-blog-title {
    ...
    .artee-site-head .artee-blog-title .artee-header {
      float: left; }
      .artee-site-head .artee-blog-title .artee-header h1 {
        font-family: "Playfair Display", Georgia, serif;
        font-weight: 700;
        display: block;
        font-size: 2.25rem;
        ...
        .artee-site-head .artee-blog-title .artee-header h1 a {
          color: inherit; }
  ...
  .artee-site-head .artee-blog-description h3 {
    ...
    @media only screen and (min-width: 40.063em) {
      .artee-site-head .artee-blog-description h3 {
        padding-bottom: 1.25rem; } }
  .artee-site-head .artee-blog-menu {
    padding-top: 0;
    ...
    font-weight: 400;
    font-size: 2.625rem; }
    .artee-site-head .artee-blog-menu .artee-mobile-menu a {
      outline: none;
      color: #252525; }
    .artee-site-head .artee-blog-menu ul {
      background: #252525;
      position: absolute;
      width: 100%;
      ...
      user-select: none; }
      .artee-site-head .artee-blog-menu ul li {
        display: block;
        margin: 0;
        width: 100%;
        font-size: 2.25rem;
        text-align: center;
        padding: 0.3125rem; }
        .artee-site-head .artee-blog-menu ul li a {
          color: #fff;
          display: block;
          width: 100%;
          height: 100%;
          outline: none; }
        .artee-site-head .artee-blog-menu ul li.artee-mobile-close-btn {
          padding-right: 1.25rem; }
          .artee-site-head .artee-blog-menu ul li.artee-mobile-close-btn a {
            color: #fff; }
      .artee-site-head .artee-blog-menu ul.opened {
        ...
        .artee-site-head .artee-blog-menu ul {
          ...
          .artee-site-head .artee-blog-menu ul li {
            ...
            .artee-site-head .artee-blog-menu ul li a {
              ...
              width: auto;
              height: auto; }
              .artee-site-head .artee-blog-menu ul li a:hover {
...
.artee-site-footer {
  ...
  .artee-site-footer .artee-social-icons {
    ...
    .artee-site-footer .artee-social-icons a {
      ...
      transition: color .3s;
      color: #252525; }
      .artee-site-footer .artee-social-icons a:hover {
        color: black;
        text-decoration: none; }
    @media only screen and (min-width: 40.063em) {
      .artee-site-footer .artee-social-icons {
